...
const Login = () => {
    ...
    const { isLoading, isError, email, error } = useSelector(state => state.auth);
            ...
            <div className="w-[450px] bg-white p-8 rounded-xl shadow shadow-slate-300">
                ...
                <form action="" className="" onSubmit={handleLogin}>
                    <div className="flex flex-col space-y-5">
                        ...
                        <div className="flex flex-row justify-between">
                            <div>
                                <label htmlFor="remember" className="flex gap-3 items-center ">
                                    <input type="checkbox" id="remember" className="w-4 h-4 border-slate-200 focus:bg-indigo-600 cursor-pointer" />
                                    Remember me
                                </label>
                            </div>
                            <div>
                        ...
                        <div className="">
                            {
                                isError && <span className='text-rose-900'>Password is wrong..!</span>
                            }
                        </div>
                        ...
                        <p className="text-center">Not registered yet? <a href="#" className="text-indigo-600 font-medium inline-flex space-x-1 items-center"><Link to='/sing-up'>Register now </Link><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
